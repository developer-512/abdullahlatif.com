...
export default function CTA({ settings }: CTAProps) {
  const heading = settings.cta_heading || "Ready to optimize your architectural stack?";
  const description =
  ...
  const buttonText = settings.cta_button_text || "Book Architecture Consultation";
    ...
    <section className="py-12 mt-12 bg-gradient-to-r from-zinc-900 via-neutral-950 to-zinc-900 rounded-3xl border border-zinc-800/60 p-8 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <a
            href={`mailto:${email}`}
            className="w-full sm:w-auto inline-flex justify-center items-center gap-2 px-5 py-2.5 bg-white text-black font-semibold rounded-xl text-sm hover:bg-emerald-400 hover:text-black transition-colors duration-200"
          >
            {buttonText}
